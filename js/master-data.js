                ...
                <tr>
                  ...
                  <td class="text-sm" style="font-family:monospace;white-space:nowrap">
                    <div style="display:flex;align-items:center;gap:6px">
                      ...
                      <button type="button" style="background:none;border:none;cursor:pointer;padding:2px 4px;color:var(--color-text-muted);line-height:1" title="Show / hide password" onclick="MasterData.togglePw(this)">
